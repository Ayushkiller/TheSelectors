...
const CreateInterview = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const formData = {
      ...form,
      requiredExpertise: expertiseEvaluation,
    };
    ...
    try {
      ...
      if (response.ok) {
        ...
        setSnackbar({
          open: true,
          message: data.detail || "Failed to create interview",
          severity: "error",
        });
      }
    } catch (err) {
  ...
  const startEvaluation = () => {
    ...
    setChatHistory([
      {
        role: "assistant",
        content: `Let's start with ${skills[0]}. Can you tell me about your experience in this area?`,
      },
    ]);
  };
      ...
      if (data.rating) {
        ...
        if (nextSkill) {
          ...
          setChatHistory(prev => [
            ...
            {
              role: "assistant",
              content: `Let's move on to ${nextSkill}. Tell me about your experience in this area.`,
            },
          ]);
        } else {
          setChatHistory(prev => [
            ...
            {
              role: "assistant",
              content: "Thank you for completing the evaluation!",
            },
          ]);
        }
      }
